...
to tell browsers to render the gaps.
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe"> 
            <li>Cut mini, seedless watermelon into 1 inch cubes.</li>
            <li>Add cubed watermelon to large bowl.</li>
            <li>Dice english cucumbers into cubes.</li>
            <li>Add cubed cucumbers to bowl.</li>
            <li>Chop mint leaves and add to bowl.</li>
            <li>Drizzle ingredients in bowl with lime.</li>
            <li>Sprinkle ingredients in bowl with salt.</li>
            <li>Gently toss ingredients in bowl.</li>
            <li>Add crumbled feta cheese on top, serve and enjoy!</li>
        </ol>
        ...
        <ul id="wd-your-books">
            <li>The Wild Party</li>
            <li>The House of Hidden Meanings</li>
            <li>Harry Potter</li>
        </ul>
      </div>
...
src="https://www.staradvertiser.com/wp-content/uploads/2021/08/web1_Starship-gap2.jpg" />
      ...
      <div id="wd-forms">
        ...
        <form id="wd-text-fields">
            ...
            <input type="text" title="Username" placeholder="jdoe" 
            id="wd-text-fields-username" />
            <br />
            
            <label htmlFor="wd-text-fields-password">Password:</label>
            <input type="password" title="Password" defaultValue="123@#$asd" 
            ...
            <br/>
            <textarea cols={30} rows={10} title="Biography"
            defaultValue="Sed ut perspiciatis unde omnis iste natus error 
            ...
            <input type="email" placeholder="jdoe@somewhere.com"
...
*/}
      ...
      <h4>Anchor tag</h4>
      Please <a href="https://www.lipsum.com" 
      id="wd-lipsum">click here</a> to get dummy text.<br/>

      Please <a href="https://github.com/aechernysheva/kambaz-next-js" 
      id="wd-github">click here</a> for my code repository on GitHub.<br/>
